...
FAB_ROLES = {
    "Provider": [
        ...
        ["submenu_bill_chart", "menu_access"],
        ["submenu_credit_balance", "menu_access"],
        ["submenu_credit_transactions", "menu_access"],
        ["submenu_bills_collected", "menu_access"],
        ...
        ["ReportBillsCollectedByPartnersView", "can_list"],
        ["CreditBalanceView", "can_list"],
        ["CreditBalanceView", "can_show"],
        ["CreditTransactionsView", "can_list"],
        ["CreditTransactionsView", "can_show"],
